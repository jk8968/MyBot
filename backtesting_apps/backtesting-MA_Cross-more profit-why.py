...
btc_usd_data=tv.get_hist('ADAUSD','BINANCE',Interval.in_daily,n_bars=1000)
...
for i in modified_hourly.index: 
    ...
    if (modified_hourly['close'][i] >= modified_hourly['MA50'][i]):
...
#---------------------------------------------------
    ...
    # if(modified_hourly['close'][i] >= (sell_price + 2 * atr_short) and in_position == -1):
    #      in_position = 0
    #      buy_price = modified_hourly['close'][i]
    ...
    # if(modified_hourly['close'][i] <  (sell_price - 7*(2 * atr_short)) and in_position == -1):
    #      in_position = 0
    #      buy_price = modified_hourly['close'][i]
